...
export const AGENT_IDENTITY = {
  ...
  posts: [
    // 'what-is-know-your-agent-kya' was folded into 'know-your-agent-kya'
    // (301 in next.config.js): it was a strict subset of the canonical post
    // and the two were cannibalising the same definitional queries.
    {
    ...
    },
    {
      ...
      blurb:
        'Why workload identity proves what a process is, not who authorized it.'
    },
    {
      slug: 'the-workload-identity-trap',
      title: 'The Workload Identity Trap',
      blurb:
        'Workload identity (SPIFFE, OAuth) is the right substrate for agents and silently incomplete without a mandate layer.'
    },
    {
      slug: 'agent-authority-derives-from-owner',
      title: "Why an Agent's Authority Should Derive From Its Owner",
      blurb:
        'An agent has no authority of its own; it carries a bounded, revocable slice of a verified owner’s. Why derived authority is the right design principle.'
    },
    {
      slug: 'delegation-chain-accountability',
      title:
        'The Delegation-Chain Problem: Who Is Accountable When an Agent Acts for You',
      blurb:
        'Single-agent delegation is easy; chains are the hard case. Why accountability must trace back through every hop to the human who started it.'
    },
    {
      slug: 'your-agent-needs-a-mandate-not-a-name',
      title: 'Your Agent Needs a Mandate, Not a Name',
      blurb:
        'Why agent identity is a scoped mandate and authority, not just a name.'
    },
    {
      ...
      blurb:
        'How Model Context Protocol servers act as identity wallets that make KYA real.'
    },
    {
      slug: 'the-agent-web-stack',
      title: 'The Agent Web Stack',
      blurb:
        'The stack an agent uses to work the open web: search, extract, interact.'
    },
    {
      slug: 'ai-social-graphs-and-the-rise-of-agent-societies',
      title: 'AI Social Graphs and the Rise of Agent Societies',
      blurb:
        'How agents discover, trust, and collaborate, forming their own social graphs.'
    },
    {
      slug: 'why-i-gave-my-ai-agent-a-physical-body',
      title: 'Why I Gave My AI Agent a Physical Body',
      blurb:
        'A physical-device experiment for human-in-the-loop agent workflows.'
    },
    {
      slug: 'when-your-agent-dies',
      title: 'When Your Agent Dies',
      blurb:
        'The missing death story for agent identity: revocation, offboarding, end of life.'
    }
  ]
};

// Set of slugs in the agent-identity cluster, for quick membership checks.
export const AGENT_IDENTITY_SLUGS = new Set(
  AGENT_IDENTITY.posts.map((p) => p.slug)
);
