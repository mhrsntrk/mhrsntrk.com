...
export const AGENT_IDENTITY = {
  ...
  posts: [
    ...
    },
    {
      ...
      blurb: 'Workload identity (SPIFFE, OAuth) is the right substrate for agents and silently incomplete without a mandate layer.'
    },
    {
      slug: 'agent-authority-derives-from-owner',
      title: "Why an Agent's Authority Should Derive From Its Owner",
      blurb: 'An agent has no authority of its own; it carries a bounded, revocable slice of a verified owner’s. Why derived authority is the right design principle.'
    },
    {
      slug: 'delegation-chain-accountability',
      title: 'The Delegation-Chain Problem: Who Is Accountable When an Agent Acts for You',
      blurb: 'Single-agent delegation is easy; chains are the hard case. Why accountability must trace back through every hop to the human who started it.'
    },
    {
