...
export const REPORTS = [
  {
    ...
    description:
      'Where the digital identity budget goes in 2026-27, which mandates force a purchase, and what a B2B buyer will sign. 25 funding rounds, ~$2.8B, every figure source-tagged.',
    date: '2026-08-12',
    updated: '2026-08-12',
    tags: [
      'digital identity',
    ...
    period: 'FY2027',
    stats: [
      { value: '$80B', label: '2030 spend' },
      { value: '109:1', label: 'machine to human' },
      { value: '25', label: 'rounds tracked' },
      { value: '24 Dec 2027', label: 'EUDI acceptance' }
    ]
  },
  {
